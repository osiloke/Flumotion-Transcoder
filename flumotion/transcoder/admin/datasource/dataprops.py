...
class ProfileData(properties.PropertyBag):
    ...
    tempRepDir = properties.String('temp-report-dir', None)
...
class ActivityData(properties.RootPropertyBag):
    ...
    customerIdentifier = properties.String('customer-id', None)
    profileIdentifier = properties.String('profile-id', None)
    targetIdentifier = properties.String('target-id', None)
